...
*/
	player createDiaryRecord["changelog",
		[
			"Bug / Feature Tracker",
				"
					The change log can be found on http://goo.gl/5ZeWvc
				"
		]
	];
		...
		[
			"Exploits", 
				...
				2. Killing yourself to get out of roleplay. Getting out of being tazed, restrained, arrested, jail, etc. Do not pay bail and kill yourself for an easy ride home.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop Interaction", 
				...
				2. Civilians can be arrested for following cops in game in order to give away their position (Ghosting).<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Boats", 
				...
				1. Purposefully running over swimmers/divers.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Aviation", 
				...
				3. Stealing helicopters without proper warning and significant time for the driver to lock the vehicle. If they land and run away without locking, fine, if they just get out and you get in before they get a chance to lock it, it's not allowed.
				4. Landing in major cities requires permission from the highest ranking officer online. Text the police and ask for permission to land and specify where you would like to land.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Vehicles", 
				...
				1. Purposefully running people over (VRDM) also known as VDM. There are accidents, and then there is going out of your way to run someone over.<br/>
				...
				7. The only reason for shooting at a vehicle would be to disable it and/or fire warning shots in a role-play scenario.You are not to deliberately destroy enemies vehicles unless they form a threat.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Illegal Areas", 
				...
				5. Police Officers are not allowed to fly over an illegal area without probable cause/illegal activity.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Patrolling", 
				...
				3. Patrols do not include illegal areas. See Raiding/Camping.<br/>
				4. Police Officers are not allowed to impound their vehicles to cover/hide their presence from civilians. <br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Checkpoints", 
				...
				1. A checkpoint must consist of 2 or more officers, utilizing 1 or more vehicles. An ATV does not count as one of the required vehicles, but may still be used.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Non-Lethal Force",
				"
				At this time the Taser (Silenced P07) and the Taser Rifle (SDAR Police side) are the only form of Non-Lethal Force.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				1. In order to raid an area, the cops must have at least 3 officers involved with at least one officer with a cop rank higher than 3.<br/>
				2. All civilians in a raid area may be restrained and searched. If nothing illegal is found, you may fine them a ticket of maximum $10000.<br/>
				...
				7. An area cannot be raided again for 30 minutes after a previous raid.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				...
				2. Please join Teamspeak BEFORE you spawn in as a cop, or as soon as possible.<br/><br/>
				"
		]
	];
